...
<header class="header">
   ...
   <section class="flex">
      ...
      <div class="profile">
         <?php
            $select_profile = $conn->prepare("SELECT * FROM `admiin` WHERE id = ?");
            $select_profile->execute([$vet_id]);
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="vet_infos.php"><i class="fa-solid fa-bars-staggered"></i><span>vet_infos</span></a>
