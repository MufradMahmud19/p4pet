...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         <a href="../admin/view_content.php?get_id=<?= $video_id; ?>" class="option-btn">view content</a>
   ...
   <?php
         ...
         echo '<p class="empty">video not found! <a href="../admin/add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
