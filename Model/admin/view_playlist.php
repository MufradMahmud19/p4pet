...
if(isset($_POST['delete_playlist'])){
   ...
   header('locatin:../admin/playlists.php');
}
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="../admin/update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">update playlist</a>
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="../admin/view_content.php?get_id=<?= $video_id; ?>" class="btn">watch video</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">no videos added yet! <a href="../admin/add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
