...
<section class="teachers">
   ...
   <h1 class="heading">Available Vets/Pharmacists</h1>

   <form action="../View/search_tutor.php" method="post" class="search-tutor">
      <input type="text" name="search_tutor" maxlength="100" placeholder="search vet/Pharmacist..." required>
   ...
   <div class="box-container">
      ...
      <div class="box offer">
         ...
         <a href="../Model/admin/register.php" target="blank" class="inline-btn">get started</a>
      </div>
      ...
      <div class="box">
         <div class="tutor">
            <img src="../Model/uploaded_files/<?= $fetch_tutor['image']; ?>" alt="">
            <div>
