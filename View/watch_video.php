...
<section class="watch-video">
   ...
   <div class="video-details">
      <video src="../Model/uploaded_files/<?= $fetch_content['video']; ?>" class="video" poster="uploaded_files/<?= $fetch_content['thumb']; ?>" controls autoplay></video>
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         <div class="user">
            <img src="../Model/uploaded_files/<?= $fetch_commentor['image']; ?>" alt="">
            <div>
